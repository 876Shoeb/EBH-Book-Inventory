...
namespace BookInventory.Areas.Admin.Controllers
{
    ...
    public class GenreController : Controller
    {
        ...
        public GenreController(BookInventoryDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Genre != null ? 
                          ...
                          Problem("Entity set 'BookInventoryDbContext.Genre'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DescriptiveName")] Genre genre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DescriptiveName")] Genre genre)
        {
            if (id != genre.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookInventoryDbContext.Genre'  is null.");
            }
            var genre = await _context.Genre.FindAsync(id);
            if (genre != null)
            {
